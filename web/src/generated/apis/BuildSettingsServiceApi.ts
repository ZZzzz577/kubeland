...
import type { ApiV1BuildSettingsBuildSettings } from "../models/index";
import { ApiV1BuildSettingsBuildSettingsFromJSON, ApiV1BuildSettingsBuildSettingsToJSON } from "../models/index";
...
export class BuildSettingsServiceApi extends runtime.BaseAPI {
    /**
     */
    async buildSettingsServiceApplyBuildSettingsRaw(
        requestParameters: BuildSettingsServiceApplyBuildSettingsRequest,
    ...
    /**
     */
    async buildSettingsServiceApplyBuildSettings(
        requestParameters: BuildSettingsServiceApplyBuildSettingsRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<void> {
    ...
    /**
     */
    async buildSettingsServiceGetBuildSettingsRaw(
        requestParameters: BuildSettingsServiceGetBuildSettingsRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<ApiV1BuildSettingsBuildSettings>> {
        if (requestParameters["name"] == null) {
            throw new runtime.RequiredError(
                "name",
    ...
    /**
     */
    async buildSettingsServiceGetBuildSettings(
        requestParameters: BuildSettingsServiceGetBuildSettingsRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<ApiV1BuildSettingsBuildSettings> {
