...
import type { ApiV1ApplicationApplication, ApiV1ApplicationListApplicationsResponse } from "../models/index";
import {
...
export class ApplicationServiceApi extends runtime.BaseAPI {
    /**
     */
    async applicationServiceCreateApplicationRaw(
        requestParameters: ApplicationServiceCreateApplicationRequest,
    ...
    /**
     */
    async applicationServiceDeleteApplicationRaw(
        requestParameters: ApplicationServiceDeleteApplicationRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<void>> {
    ...
    /**
     */
    async applicationServiceGetApplicationRaw(
        requestParameters: ApplicationServiceGetApplicationRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<ApiV1ApplicationApplication>> {
        if (requestParameters["name"] == null) {
            throw new runtime.RequiredError(
                "name",
    ...
    async applicationServiceGetApplication(
        requestParameters: ApplicationServiceGetApplicationRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<ApiV1ApplicationApplication> {
    ...
    /**
     */
    async applicationServiceListApplicationsRaw(
        requestParameters: ApplicationServiceListApplicationsRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<ApiV1ApplicationListApplicationsResponse>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) =>
            ApiV1ApplicationListApplicationsResponseFromJSON(jsonValue),
        );
    }
    ...
    async applicationServiceListApplications(
        requestParameters: ApplicationServiceListApplicationsRequest = {},
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<ApiV1ApplicationListApplicationsResponse> {
    ...
    /**
     */
    async applicationServiceUpdateApplicationRaw(
        requestParameters: ApplicationServiceUpdateApplicationRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<void>> {
        if (requestParameters["name"] == null) {
            throw new runtime.RequiredError(
