...
import type { ApiV1GitGitSettings, ApiV1GitListBranchesResponse, ApiV1GitListCommitsResponse } from "../models/index";
import {
...
export class GitServiceApi extends runtime.BaseAPI {
    /**
     */
    async gitServiceApplyGitSettingsRaw(
        requestParameters: GitServiceApplyGitSettingsRequest,
    ...
    /**
     */
    async gitServiceApplyGitSettings(
        requestParameters: GitServiceApplyGitSettingsRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<void> {
    ...
    /**
     */
    async gitServiceGetGitSettingsRaw(
        requestParameters: GitServiceGetGitSettingsRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<ApiV1GitGitSettings>> {
        if (requestParameters["name"] == null) {
            throw new runtime.RequiredError(
                "name",
    ...
    /**
     */
    async gitServiceGetGitSettings(
        requestParameters: GitServiceGetGitSettingsRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<ApiV1GitGitSettings> {
    ...
    /**
     */
    async gitServiceListBranchesRaw(
        requestParameters: GitServiceListBranchesRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<ApiV1GitListBranchesResponse>> {
        if (requestParameters["name"] == null) {
            throw new runtime.RequiredError(
                "name",
    ...
    /**
     */
    async gitServiceListBranches(
        requestParameters: GitServiceListBranchesRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<ApiV1GitListBranchesResponse> {
    ...
    /**
     */
    async gitServiceListCommitsRaw(
        requestParameters: GitServiceListCommitsRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<ApiV1GitListCommitsResponse>> {
        if (requestParameters["name"] == null) {
            throw new runtime.RequiredError(
                "name",
    ...
    /**
     */
    async gitServiceListCommits(
        requestParameters: GitServiceListCommitsRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<ApiV1GitListCommitsResponse> {
