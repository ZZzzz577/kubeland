...
export class ClusterServiceApi extends runtime.BaseAPI {
    ...
    /**
     */
    async clusterServiceCreateClusterRaw(requestParameters: ClusterServiceCreateClusterRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
    ...
    /**
     */
    async clusterServiceGetClusterRaw(requestParameters: ClusterServiceGetClusterRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApiV1ClusterCluster>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
    ...
    /**
     */
    async clusterServiceGetCluster(requestParameters: ClusterServiceGetClusterRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ApiV1ClusterCluster> {
    ...
    /**
     */
    async clusterServiceListClustersRaw(requestParameters: ClusterServiceListClustersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApiV1ClusterListClustersResponse>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ApiV1ClusterListClustersResponseFromJSON(jsonValue));
    }

    /**
     */
    async clusterServiceListClusters(requestParameters: ClusterServiceListClustersRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ApiV1ClusterListClustersResponse> {
    ...
    /**
     */
    async clusterServiceResolveKubeConfigRaw(requestParameters: ClusterServiceResolveKubeConfigRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApiV1ClusterResolveKubeConfigResponse>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ApiV1ClusterResolveKubeConfigRequestToJSON(requestParameters['apiV1ClusterResolveKubeConfigRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ApiV1ClusterResolveKubeConfigResponseFromJSON(jsonValue));
    }

    /**
     */
    async clusterServiceResolveKubeConfig(requestParameters: ClusterServiceResolveKubeConfigRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ApiV1ClusterResolveKubeConfigResponse> {
    ...
    /**
     */
    async clusterServiceTestConnectionRaw(requestParameters: ClusterServiceTestConnectionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApiV1ClusterTestConnectionResponse>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ApiV1ClusterTestConnectionResponseFromJSON(jsonValue));
    }
    ...
    /**
     */
    async clusterServiceUpdateClusterRaw(requestParameters: ClusterServiceUpdateClusterRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
    ...
    /**
     */
    async clusterServiceUpdateCluster(requestParameters: ClusterServiceUpdateClusterRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
