...
type ApplicationApplyConfiguration struct {
	...
	*metav1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	...
	Status                               *applicationv1.ApplicationStatus   `json:"status,omitempty"`
}
...
func (b *ApplicationApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *ApplicationApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *ApplicationApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *ApplicationApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *ApplicationApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *ApplicationApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
...
func (b *ApplicationApplyConfiguration) WithStatus(value applicationv1.ApplicationStatus) *ApplicationApplyConfiguration {
	b.Status = &value
	return b
}
