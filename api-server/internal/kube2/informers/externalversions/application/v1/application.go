...
import (
	apisapplicationv1 "api-server/internal/kube2/apis/application/v1"
	versioned "api-server/internal/kube2/clientset/versioned"
	internalinterfaces "api-server/internal/kube2/informers/externalversions/internalinterfaces"
	applicationv1 "api-server/internal/kube2/listers/application/v1"
	context "context"
	time "time"
...
type ApplicationInformer interface {
	...
	Lister() applicationv1.ApplicationLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.KubelandV1().Applications(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubelandV1().Applications(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options metav1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubelandV1().Applications(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubelandV1().Applications(namespace).Watch(ctx, options)
			},
		},
		&apisapplicationv1.Application{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *applicationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisapplicationv1.Application{}, f.defaultInformer)
}

func (f *applicationInformer) Lister() applicationv1.ApplicationLister {
	return applicationv1.NewApplicationLister(f.Informer().GetIndexer())
}
