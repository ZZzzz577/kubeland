...
type ClusterFunc func(context.Context, *generated.ClusterMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f ClusterFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.ClusterMutation); ok {
		return f(ctx, mv)
	}
