...
func (_q *ApplicationQuery) QueryCluster() *ClusterQuery {
...
func (_q *ApplicationQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *ApplicationQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *ApplicationQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *ApplicationQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *ApplicationQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *ApplicationQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ApplicationQuery) WithCluster(opts ...func(*ClusterQuery)) *ApplicationQuery {
	query := (&ClusterClient{config: _q.config}).Query()
...
func (_q *ApplicationQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Application, error) {
	...
	if query := _q.withCluster; query != nil {
		if err := _q.loadCluster(ctx, query, nodes, nil,
			func(n *Application, e *Cluster) { n.Edges.Cluster = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *ApplicationQuery) loadCluster(ctx context.Context, query *ClusterQuery, nodes []*Application, init func(*Application), assign func(*Application, *Cluster)) error {
...
func (_q *ApplicationQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withCluster != nil {
			_spec.Node.AddColumnOnce(application.FieldClusterID)
		}
	}
