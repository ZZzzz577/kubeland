...
const (
	// Label holds the string label denoting the clustersecurity type in the database.
	Label = "cluster_security"
	...
	EdgeCluster = "cluster"
	// Table holds the table name of the clustersecurity in the database.
	Table = "cluster_securities"
	// ClusterTable is the table that holds the cluster relation/edge.
	ClusterTable = "cluster_securities"
...
// Columns holds all SQL columns for clustersecurity fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the ClusterSecurity queries.
